...
- Biểu diễn tin tức: mỗi tin là một vector trên không gian *user* - vector[i] = 1 nếu user i đã đọc tin đó, ngược lại 0. Hai tin được cùng một nhóm user đọc thì vector của chúng gần nhau → chúng "giống nhau".
